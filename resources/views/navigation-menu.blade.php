<nav x-data="{ open: false }" class="bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 @if(request()->routeIs('articles.create') || request()->routeIs('articles.edit')) hidden @endif">
